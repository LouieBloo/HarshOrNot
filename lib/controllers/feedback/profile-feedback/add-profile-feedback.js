...
module.exports.add = async (req, res, next) => {
  ...
  //dont add feedback about yourself
  if(validData.target == req.payload._id){
    throw({error:"Can't add feedback about yourself"});
  }
  ...
  if(match){
    //match is the other persons feedback
    newProfileFeedback.wouldTheyDate = match.wouldYouDate;
