    ...
    return new Promise(function(resolve,reject){
        ...
        return new Promise(function(resolve,reject){
            ...
            userModel.findOneAndUpdate(
                ...
                (err,result)=>{
                    resolve({photos:result.photos,photoURLS:generatePhotoURLS(result,req.payload._id)});
                },
            );
        })
    })
...
var generatePhotoURLS = function(photoArr,userID){
    var finalURLArr = [];
    photoArr.photos.forEach(function(file)
    {
